...
class fedopt(fedavg):
    def __init__(self, server_model, scenario, loss_fun, global_lr, fed_method='fedopt', device='cuda'):
        super(fedopt, self).__init__(server_model, scenario, loss_fun, fed_method, device)
